...
import com.kencloud.workchat.app_adapter.InteractiveArrayAdapter;
import com.kencloud.workchat.app_model.Model;
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.mybutton:
                ...
                if(s1.equals("")){
                    Toast.makeText(NewGroupActivity.this, "Please Enter Any Text", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(groupCursor.getCount() > 0){
                    Toast.makeText(NewGroupActivity.this, "Group is already available",     Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    Toast.makeText(NewGroupActivity.this, "Not available", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Log.d("Group Created :","Success");
                    }
                    catch(Exception e){
                        Log.d("########### Exception :",""+e.getMessage());
                    }
                    Toast.makeText(NewGroupActivity.this, "Created Successfully",                                       Toast.LENGTH_SHORT).show();
                }
                ...
                for(int i=0; i<InteractiveArrayAdapter.list.size(); i++)  {
                    if(InteractiveArrayAdapter.list.get(i).isSelected()) {
                        ...
                        Toast.makeText(NewGroupActivity.this, name+" Added Successfully",   Toast.LENGTH_SHORT).show();
                    }
                }
